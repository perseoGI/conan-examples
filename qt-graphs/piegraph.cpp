...
PieGraph::~PieGraph() { delete m_pieSeries; }

QPieSeries *PieGraph::pieSeries() const { return m_pieSeries; }
...
void PieGraph::removeSlice() { m_pieSeries->remove(m_pieSeries->count() - 1); }
...
void PieGraph::clearSeries() { m_pieSeries->clear(); }

void PieGraph::fillSliceInfo() {
    m_sliceInfo.value = {10, 15, 20, 25, 30, 35};
    m_sliceInfo.label = {"Strawberry", "Blueberry", "Raspberry", "Grape", "Banana", "Melon"};
    m_sliceInfo.color = {"white", "red", "green", "blue", "grey", "yellow"};
}

void PieGraph::onAddSlice() { appendSlice(); }

void PieGraph::onRemoveSlice() { removeSlice(); }

void PieGraph::onExplode() { explodeSlices(); }

void PieGraph::onClearSeries() { clearSeries(); }
